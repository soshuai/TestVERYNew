...
public class SelectableRoundedImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    private float mLeftTopCornerRadius = 10.0f;
    private float mRightTopCornerRadius = 10.0f;
    private float mLeftBottomCornerRadius = 10.0f;
    private float mRightBottomCornerRadius = 10.0f;
